...
prop_replace 'nifi.web.proxy.host'                              "${PUBLIC_IP}:${HTTPS_PORT},${PUBLIC_IP}:${HTTP_PORT}"
...
#     echo "Set admin initial password to: " $ADMIN_PASSWORD
#     ${NIFI_HOME}/bin/nifi.sh set-single-user-credentials $ADMIN_USER $ADMIN_PASSWORD
    
#     echo "Will restart NiFi instance"
